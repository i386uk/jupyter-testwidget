...
# -*- coding: utf-8 -*-
#
# testwidgetexample documentation build configuration file
#
...
project = 'testwidgetexample'
copyright = '2018, Xiaofan Li'
author = 'Xiaofan Li'
...
_version_py = os.path.join(repo, 'testwidgetexample', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'testwidgetexampledoc'
...
latex_documents = [
    (master_doc, 'testwidgetexample.tex', 'testwidgetexample Documentation',
     'Xiaofan Li', 'manual'),
]
...
man_pages = [
    (master_doc,
    'testwidgetexample',
    'testwidgetexample Documentation',
     [author], 1)
]
